...
CREATE TABLE `biz_doc_history`  (
  ...
  INDEX `pid_time_idx`(`pid` ASC, `time` ASC) USING BTREE,
...
INSERT INTO `biz_doc_history` VALUES (71, 'XSDD202411040001', 1, 1, 'admin', 0, 1, 1730698089793, NULL);
INSERT INTO `biz_doc_history` VALUES (72, 'XSDD202411040001', 2, 1, 'admin', 1, 2, 1730698093709, NULL);
INSERT INTO `biz_doc_history` VALUES (73, 'XSCK202411040001', 1, 1, 'admin', 0, 1, 1730698117982, NULL);
INSERT INTO `biz_doc_history` VALUES (74, 'XSCK202411040001', 2, 1, 'admin', 1, 2, 1730698120876, NULL);
INSERT INTO `biz_doc_history` VALUES (75, 'CGDD202411040001', 1, 1, 'admin', 0, 1, 1730698203457, NULL);
INSERT INTO `biz_doc_history` VALUES (76, 'CGDD202411040001', 2, 1, 'admin', 1, 2, 1730698206219, NULL);
INSERT INTO `biz_doc_history` VALUES (77, 'CGRK202411040001', 1, 1, 'admin', 0, 1, 1730698219471, NULL);
INSERT INTO `biz_doc_history` VALUES (78, 'CGRK202411040001', 2, 1, 'admin', 1, 2, 1730698223244, NULL);
INSERT INTO `biz_doc_history` VALUES (79, 'XSDD202411040002', 1, 1, 'admin', 0, 1, 1730698325735, NULL);
INSERT INTO `biz_doc_history` VALUES (80, 'XSDD202411040002', 2, 1, 'admin', 1, 2, 1730698328667, NULL);
...
CREATE TABLE `biz_purchase_inbound`  (
  ...
  INDEX `cid_idx`(`cid` ASC) USING BTREE,
  INDEX `ctime_idx`(`ctime` ASC) USING BTREE,
...
INSERT INTO `biz_purchase_inbound` VALUES ('CGRK202411040001', 'CGDD202411040001', 1, 'admin', 1730698219456, 1, 'admin', 1730698223244, 2, NULL);
...
CREATE TABLE `biz_purchase_inbound_sub`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `pid_cid_unique_idx`(`pid` ASC, `cid` ASC) USING BTREE COMMENT '同一采购入库单不能有重复分类的商品'
...
INSERT INTO `biz_purchase_inbound_sub` VALUES (26, 'CGRK202411040001', 4, '肥宅快乐水', 7.00);
...
CREATE TABLE `biz_purchase_order`  (
  ...
  INDEX `ctime_idx`(`ctime` ASC) USING BTREE,
  INDEX `status_idx`(`status` ASC) USING BTREE,
  INDEX `finish_idx`(`finish` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `biz_purchase_order` VALUES ('CGDD202411040001', 1, '供应商1号', 1, 'admin', 1730698203444, 1, 'admin', 1730698206219, 2, 2, 1730698223244, 21.00, NULL);
...
CREATE TABLE `biz_purchase_order_sub`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `pid_cid_unique_idx`(`pid` ASC, `cid` ASC) USING BTREE
...
INSERT INTO `biz_purchase_order_sub` VALUES (33, 'CGDD202411040001', 4, '肥宅快乐水', 7.00, 3.00, 0.00);
...
INSERT INTO `biz_sell_order` VALUES ('XSDD202411040001', 2, '测试客户2号', 1, 'admin', 1730698089744, 1, 'admin', 1730698093709, 2, 2, 1730698120876, 10.00, NULL);
INSERT INTO `biz_sell_order` VALUES ('XSDD202411040002', 1, '测试客户1', 1, 'admin', 1730598117965, 1, 'admin', 1730598117965, 2, 0, NULL, 6993.00, NULL);
...
CREATE TABLE `biz_sell_order_sub`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `pid_cid_unique_idx`(`pid` ASC, `cid` ASC) USING BTREE COMMENT '同一张销售订单内不能有重复分类的商品'
...
INSERT INTO `biz_sell_order_sub` VALUES (9, 'XSDD202411040001', 1, '马良铅笔', 5.00, 2.00, 0.00);
INSERT INTO `biz_sell_order_sub` VALUES (10, 'XSDD202411040002', 4, '肥宅快乐水', 7.00, 999.00, 7.00);
...
INSERT INTO `biz_sell_outbound` VALUES ('XSCK202411040001', 'XSDD202411040001', 1, 'admin', 1730598117965, 1, 'admin', 1730598117965, 2, NULL);
...
INSERT INTO `biz_sell_outbound_sub` VALUES (9, 'XSCK202411040001', 12, 1, '马良铅笔', 5.00);
...
CREATE TABLE `biz_stock`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `cid_cgrkid_unique_idx`(`cid` ASC, `cgrkid` ASC) USING BTREE,
  INDEX `cdate_idx`(`ctime` ASC) USING BTREE
...
INSERT INTO `biz_stock` VALUES (12, 1, '马良铅笔', 0.00, 4.00, 1595302628775, 'CGRK202007210001', 'CGDD202007190001');
INSERT INTO `biz_stock` VALUES (13, 6, '神光棒', 0.00, 5.00, 1596383444152, 'CGRK202008020001', 'CGDD202008020001');
INSERT INTO `biz_stock` VALUES (14, 4, '肥宅快乐水', 7.00, 3.00, 1730698223244, 'CGRK202411040001', 'CGDD202411040001');
...
CREATE TABLE `msg_state`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `mid_idx`(`mid` ASC) USING BTREE,
  INDEX `uid_idx`(`uid` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of msg_state
-- ----------------------------
...
CREATE TABLE `rec_attachment`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `pid_idx`(`pid` ASC) USING BTREE,
  INDEX `url_idx`(`url` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of rec_attachment
-- ----------------------------
...
CREATE TABLE `rec_login_history`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `uid_idx`(`uid` ASC) USING BTREE,
  INDEX `type_idx`(`login` ASC) USING BTREE,
  INDEX `time_idx`(`time` ASC) USING BTREE
...
-- ----------------------------
INSERT INTO `rec_login_history` VALUES (875, 1, 'admin', '127.0.0.1', NULL, 1, 1730695490351);
INSERT INTO `rec_login_history` VALUES (876, 1, 'admin', '127.0.0.1', NULL, 1, 1730695829521);
...
-- ----------------------------
-- Records of rec_user_action
-- ----------------------------
INSERT INTO `rec_user_action` VALUES (178, 1, 'admin', '127.0.0.1', '/doc/sell/order/commit', 1730698089748, '提交销售订单null', NULL, 1);
INSERT INTO `rec_user_action` VALUES (179, 1, 'admin', '127.0.0.1', '/doc/sell/order/pass', 1730698093707, '通过销售订单XSDD202411040001', NULL, 1);
INSERT INTO `rec_user_action` VALUES (180, 1, 'admin', '127.0.0.1', '/doc/sell/outbound/commit', 1730698117965, '提交销售出库单null', NULL, 1);
INSERT INTO `rec_user_action` VALUES (181, 1, 'admin', '127.0.0.1', '/doc/sell/outbound/pass', 1730698120874, '通过销售出库单XSCK202411040001', NULL, 1);
INSERT INTO `rec_user_action` VALUES (182, 1, 'admin', '127.0.0.1', '/doc/purchase/order/commit', 1730698203444, '提交采购订单null', NULL, 1);
INSERT INTO `rec_user_action` VALUES (183, 1, 'admin', '127.0.0.1', '/doc/purchase/order/pass', 1730698206218, '通过采购订单CGDD202411040001', NULL, 1);
INSERT INTO `rec_user_action` VALUES (184, 1, 'admin', '127.0.0.1', '/doc/purchase/inbound/commit', 1730698219456, '提交采购入库单null', NULL, 1);
INSERT INTO `rec_user_action` VALUES (185, 1, 'admin', '127.0.0.1', '/doc/purchase/inbound/pass', 1730698223242, '通过采购入库单CGRK202411040001', NULL, 1);
INSERT INTO `rec_user_action` VALUES (186, 1, 'admin', '127.0.0.1', '/doc/sell/order/commit', 1730698325730, '提交销售订单null', NULL, 1);
INSERT INTO `rec_user_action` VALUES (187, 1, 'admin', '127.0.0.1', '/doc/sell/order/pass', 1730698328666, '通过销售订单XSDD202411040002', NULL, 1);
...
INSERT INTO `stat_finish_order` VALUES (223, 0, 0, 1730563200000);
...
INSERT INTO `stat_profit_total` VALUES (223, 0.00, 0.00, 0.00, 1730563200000);
...
CREATE TABLE `sys_category`  (
  ...
  `ctime` bigint(20) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `name_unique_idx`(`name` ASC) USING BTREE,
  INDEX `pid_idx`(`pid` ASC) USING BTREE,
  INDEX `type_idx`(`leaf` ASC) USING BTREE
...
CREATE TABLE `sys_customer`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `name_unique_idx`(`name` ASC) USING BTREE,
  INDEX `status_idx`(`enable` ASC) USING BTREE,
  INDEX `ctime_idx`(`ctime` ASC) USING BTREE
...
CREATE TABLE `sys_department`  (
  ...
  `enable` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否启用，0否1是',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `pid_name_unique_idx`(`pid` ASC, `name` ASC) USING BTREE
...
CREATE TABLE `sys_region`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `pid_idx`(`pid` ASC) USING BTREE,
  INDEX `level_idx`(`level` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_user`  (
  ...
  `enable` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否启用，0否1是',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `name_pwd_unique`(`login_name` ASC, `pwd` ASC) USING BTREE COMMENT '登录名和密码唯一'
